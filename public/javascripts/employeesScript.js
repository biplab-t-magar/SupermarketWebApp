...
let employeeListContainer = document.querySelector("div.container");
let container=""
employeeArray.forEach(function (item, index) {
	let containerDiv = document.createElement('div');
	containerDiv.classList.add("card");
	containerDiv.style.width = "18rem";
	// employeeListContainer.appendChild(containerDiv);
	container=document.querySelector("#column_"+(index%3+1).toString());
